...
CAUSALM_DIR = '/data2/yifan.zhang/CausaLM-master/' # This must be set to the path which specifies where the CausaLM project resides
...
SENTIMENT_ADJECTIVES_DATASETS_DIR = f"{CAUSALM_DIR}/datasets"
...
SENTIMENT_TOPICS_DATASETS_DIR = f"{CAUSALM_DIR}/datasets"
...
POMS_GENDERACE_DATASETS_DIR = f"{CAUSALM_DIR}/datasets"
