...
#     def __init__(self, d_model, nhead=2, dim_feedforward=2048, dropout=0.1, activation="relu", layer_norm_eps=1e-5):
...
class TransformerEncoderLayer(Module):
    ...
    def __init__(self, d_model, nhead=4, dim_feedforward=50, dropout=0.1, activation="relu", num_cov=25):
        super(TransformerEncoderLayer, self).__init__()
        self.self_attn = MultiheadAttention(d_model, nhead, dropout=dropout)
        # Implementation of Feedforward model
        self.linear1 = Linear(d_model, dim_feedforward)
...
class TransformerDecoderLayer(Module):
    ...
    def __init__(self, d_model, nhead=4, dim_feedforward=2048, dropout=0.1, activation="relu", num_t=1):
        super(TransformerDecoderLayer, self).__init__()
        self.self_attn = MultiheadAttention(d_model, nhead, dropout=dropout)
        self.multihead_attn = MultiheadAttention(d_model, nhead, dropout=dropout)
        # Implementation of Feedforward model
